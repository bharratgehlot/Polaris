...
function Planning() {
  ...
  const feedbackObjectTech = {
    "React+Node.js": {
      message: "🚀 Excellent choice! Popular and well-supported stack",
      type: "great",
    },
    "Angular+Java": {
      message: "🏢 Enterprise-grade stack, perfect for large apps",
      type: "great",
    },
    "Vanilla JavaScript+Ruby on rails": {
      message: "⚠️ Uncommon combo, consider modern frontend framework",
      type: "warning",
    },
  };
  ...
  const getfeedbackObjectTech = () => {
    ...
    if (
      planningData.frontend === "Not Required" ||
      planningData.frontend === "Other" ||
      planningData.backend === "Not Required" ||
      planningData.backend === "Other"
    )
      return null;

    const key = `${planningData.frontend}+${planningData.backend}`;
    return (
      feedbackObjectTech[key] || {
        message:
          "💡 Interesting combination! Make sure they work well together",
        type: "neutral",
      }
    );
  };
  ...
  const getfeedbackObjectDatabase = () => {
    ...
    if (
      planningData.database === "Not Required" ||
      planningData.database === "Other"
    )
      return null;

    const key = `${planningData.database}`;
    return (
      feedbackObjectDatabase[key] || {
  ...
  const getfeedbackObjectFeatures = () => {
    ...
    return {
      message:
        "💡 Keep it simple: limit to 3-5 features when using AI tools to avoid complexity",
    };
  };
  ...
  return (
    <div className="page-container">
            ...
            <div className="preview-grid">
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.frontend || "Not selected"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.backend || "Not selected"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.database || "Not selected"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.styling || "Not selected"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.compLibraries || "Not selected"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedPlanningData.pages || "Not selected"}
                </span>
              </div>
      ...
      <div className="page-sections">
            ...
            {getBackendFrameworkOptions().length > 0 && (
              <div className="input-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleSelectChange("backendFramework", e.target.value)
                  }
                >
        ...
        <div className="page-card">
          <div className="card-header">
            ...
            <p className="card-description">
              Select styling frameworks and libraries
            </p>
          </div>
          ...
          <div className="grid-responsive">
            ...
            <div className="input-group">
              ...
              <select
                ...
                onChange={(e) =>
                  handleSelectChange("compLibraries", e.target.value)
                }
              >
            ...
            <div className="input-group">
              ...
              >
                ...
                <option value="Small App (1-3 pages)">
                  Small App (1-3 pages)
                </option>
                <option value="Medium App (4-7 pages)">
                  Medium App (4-7 pages)
                </option>
        ...
        <div className="page-card">
          ...
          <div className="grid-responsive">
            ...
            <div className="input-group">
              <label className="input-label" style={{ opacity: 0 }}>
                Add
              </label>
              <button
                type="button"
          ...
          {planningData.features.filter(
            (feature) => !featuresOptions.includes(feature)
          ).length > 0 && (
            <div className="grid-responsive">
      ...
      <div className="next-section">
        <button className="next-button" onClick={() => navigate("/design")}>
          Continue to Design →
        </button>
      </div>
    </div>

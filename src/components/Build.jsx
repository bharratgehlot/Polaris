            ...
            <div className="preview-grid">
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedBuildData.buildTool || "Not saved"}
                </span>
              </div>
              ...
              <div className="preview-item">
                ...
                <span className="preview-value">
                  {savedBuildData.frontEndHosting || "Not saved"}
                </span>
              </div>
              <div className="preview-item">
                <span className="preview-label">Backend Hosting</span>
                <span className="preview-value">
                  {savedBuildData.backendHosting || "Not saved"}
                </span>
              </div>
              <div className="preview-item">
                <span className="preview-label">Database Hosting</span>
                <span className="preview-value">
                  {savedBuildData.databaseHosting || "Not saved"}
                </span>
              </div>
      ...
      <div className="page-sections">
        ...
        <div className="page-card">
          <div className="card-header">
            ...
            <p className="card-description">Configure your build environment</p>
          </div>
          ...
          <div className="grid-responsive">
            ...
            <div className="input-group">
              ...
              >
                ...
                <option value="vite">
                  Vite - for React, Vue, Svelte, PReact
                </option>
                <option value="webpack">Webpack Bundler</option>
                <option value="parcel">Parcel - Zero-config bundler</option>
                <option value="gatsby">Gatsby</option>
                <option value="turbopack">Turbopack</option>
            ...
            <div className="input-group">
              <label className="input-label">Frontend Hosting</label>
              <select
                className="modern-select"
                value={buildData.frontEndHosting}
                onChange={(e) => handleBuildChange("frontEndHosting", e.target.value)}
              >
            ...
            <div className="input-group">
              <label className="input-label">Backend/Fullstack Hosting</label>
              <select
                className="modern-select"
                value={buildData.backendHosting}
                onChange={(e) => handleBuildChange("backendHosting", e.target.value)}
              >
            ...
            <div className="input-group">
              <label className="input-label">Database Hosting</label>
              <select
                className="modern-select"
                value={buildData.databaseHosting}
                onChange={(e) => handleBuildChange("databaseHosting", e.target.value)}
              >
                ...
                <option value="firebase-db">
                  Firebase Firestore/Realtime DB
                </option>
                <option value="redis-cloud">Redis Cloud</option>
          ...
          <div className="grid-responsive">
            ...
            <div className="input-group">
              ...
              <select
                ...
                onChange={(e) =>
                  handleBuildChange("customDomain", e.target.value)
                }
              >
